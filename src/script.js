...
function australia(userAnswer) {
  ...
  // 100 pts
  const isCorrect = userAnswer.toLowerCase() === 'Canberra'.toLowerCase();
...
function canada(userAnswer) {
  ...
  // 100 pts
   const isCorrect = userAnswer.toLowerCase() === "Ottawa".toLowerCase();
...
function uppercase(userAnswer, word) {
  ...
  const isCorrect = userAnswer === cap;
